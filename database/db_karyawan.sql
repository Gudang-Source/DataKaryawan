...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2019 at 03:12 AM
...
(5, '555', 'bayu bo', 'JKT', '2019-10-01', 'l', 1, 'menikah', 'bks', '1234', 's5', 1, 1, '2019-10-23', '400-TableTalk-icon-food-rgb.png');
...
--
ALTER TABLE `karyawan`
  MODIFY `id_karyawan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
